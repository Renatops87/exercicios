do while .t. //login
   ...
   if cUsuario <> "SUPER" .or. cSenha <> "123mudar"
      @ 15,35 say "Usuario ou Senha Incorreta"
      inkey(0)
      clear
      loop
   else
   ...
   do while .t. // menu
      ...
      do while .t. // program
         ...
         @ 07,17 get dDataCompra                                 valid !Empty(dDataCompra)
         @ 07,50 get cEntregaDomicilio     picture "@!"          valid cEntregaDomicilio $"S/N"
         @ 07,63 get nLimiteCliente        picture "@E 9,999.99" valid nLimiteCliente > 0
         read
