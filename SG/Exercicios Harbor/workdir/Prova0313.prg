...
do while .t.
   ...
   do while nContador < nNumeroEmpregados
      ...
      nTotalTrabalhado := nAnoDemissao - nAnoAtual
      ...
      if nAnoDemissao >= 2005 .or. nAnoDemissao <= 2006
      ...
      if nIdadeColaborador >= 65 .and. nTotalTrabalhado >= 30 .and. cSexoColaborador == "M"
         nHomemApto++
         cContaAposentado++
         nTotalRemuneracao += nValorSalarioBase
      elseif nIdadeColaborador >= 60 .and. nTotalTrabalhado >= 25 .and. cSexoColaborador == "F"
         nMulherApta++
         cContaAposentado++
         nTotalRemuneracao += nValorSalarioBase
      endif
      ...
      @ 21,02 say "Pressione qualquer tecla para continuar"
      inkey (0)
      clear
   enddo
   ...
   if (nRespostaCancelar == 1)
      ...
      @ 06,03 say "Quantidade de mulheres que pagam IRRF: " + alltrim(str(nQuantidadeFcomIrrf))
